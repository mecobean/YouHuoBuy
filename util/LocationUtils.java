...
//                sb.append("\naddr : ");
                ...
                ToastUtils.toast(location.getAddrStr());
//                sb.append("\ndescribe : ");
//                sb.append("gps定位成功");
...
//                sb.append("离线定位成功，离线定位结果也是有效的");
               ...
               sb.append("定位失败，请检查您的网络连接或GPS");
                ToastUtils.toast("定位失败，请检查您的网络连接或GPS");
            }
...
//            Log.i("BaiduLocationApiDem", sb.toString());
            locationListener.locationCallBack(sb.toString());
        }
    }
    ...
    public interface OnLocationListener{
        void locationCallBack(String s);
    }
